      ...
      function fetchLastCitizen($lastCitizenAdd)
        {
                ...
                $('#fetchLastCitizen').prepend('<tr  class="offerRow'+$lastCitizenAdd.id+' bg-gray-50 hover:scale-95 transform transition-all ease-in">\
                    ...
                    <span class="bg-green-400 text-gray-50 rounded-md px-2">'+$lastCitizenAdd.observer.agent.agentName+'</span>\
                    </td>\
                    <td class="p-3 text-center ">\
                        ...
                        <div id="action-div" class="flex justify-center">\
                            <a onclick="deleteAlert();" href="#" citId="'+$lastCitizenAdd.id+'"  class="citizenDelete text-red-500  hover:text-red-400  ">\
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">\
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />\
                                </svg>\
                            </a>\
                            <a href="#"  citId="'+$lastCitizenAdd.id+'"  class="citizenEdit text-yellow-500 hover:text-yellow-400 mx-2 ">\
