                  ...
                  <div class="grid grid-cols-6 gap-4">
                    ...
                    <div class="md:col-span-2 sm:col-span-6 lg:col-span-2">
                      <div class="relative z-0 w-full">
                        ...
                        <label for="name" class="absolute duration-300 top-3 -z-1 origin-0 text-gray-500">رقم
                          الهويه</label>
                    ...
                    <div class="md:col-span-2 sm:col-span-6 lg:col-span-2">
                      ...
                      <div class="relative z-0 w-full ">
                        ...
                        <label for="password" class="absolute duration-300 top-3 -z-1 origin-0 text-gray-500">الرقم السري
                        </label>
                  ...
                  <div class="grid grid-cols-2 gap-4">
                    <div class="span-col-1 flex flex-col items-center">
                        ...
                        <label for="file-ip-1"
                          ...
                          <input id="file-ip-1" accept="image/*" onchange="showPreviewUser(event);" type="file"
                            class="sr-only">
                        </label>
    
                        <div class="mt-4 flex h-48 w-full  border-2 bg-gray-200 border-gray-500 border-dashed rounded">
