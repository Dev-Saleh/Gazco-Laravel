                ...
                <tbody id='fetch_Allagent'>
                  ...
                  <tr class="offerRow{{$agent -> id}} animate__animated bg-white hover:scale-95 transform transition-all ease-in">
                    ...
                    <td class="p-3 grid grid-cols-2 justify-center">
                      <a href="#"  agent="{{$agent->id}}"  class="agent_delete  text-red-400  hover:text-red-600  ">
                      ...
                      <a href="#" agent="{{$agent->id}}"  id="agent_edit" class="text-yellow-400 hover:text-yellow-600">
