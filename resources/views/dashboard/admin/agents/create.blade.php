          ...
          <div class="ml-10 p-6 bg-white border-0 shadow-lg rounded-xl w-full h-full">
            <div class="flex-col items-center justify-center flex space-y-4">
              <label for="file-ip-1"
                ...
                <span>رفع صوره</span>
                <input id="file-ip-1" accept="image/*" onchange="showPreviewUser(event);" type="file" class="sr-only">
              </label>
              ...
              <button onclick="alert.show(`Dev SAleh`,`success`)" type="submit"
                ...
                <tbody>
                  <tr class="bg-gray-50 hover:scale-95 transform transition-all ease-in">
                    ...
                    <td class="p-3 text-right">
                      <img class="rounded-full h-12 w-12  object-cover" src="/assest/Dev-SL.jpeg" alt="unsplash image">
                    </td>
                    <td class="p-3 text-center">
                      <span class="bg-green-400 text-gray-50 rounded-md px-2">Admin</span>
                    </td>
                  ...
                  <tr class="bg-gray-50 hover:scale-95 transform transition-all ease-in">
                    ...
                    <td class="p-3 text-center">
                      <span class="bg-yellow-400 text-gray-50 rounded-md px-2">User</span>
                    </td>
                    <td class="p-5 flex space-x-2">
                      <a href="#" class="text-gray-400  hover:text-red-400 float-left ">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
