                 ...
                 <div class="shadow overflow-hidden sm:rounded-md">
                     <div class="px-4 py-5 bg-white sm:p-6 flex flex-col items-center">
                         <div class="flex flex-col">
                             <div class="">
                                 <div class="relative z-0 w-full mb-5">
                                     <input type="text" name="directorate_name" id="directorate_name" placeholder=" "
                                         required
                       ...
                       focus:outline-none focus:ring-0 focus:border-blue-600 border-gray-200" />
                                 ...
                                 <button type="submit" id='save_directorate'
                  ...
                  focus:outline-none focus:ring-1 focus:ring-offset-2 focus:ring-blue-500  w-full">
                                 ...
                                 <button type="submit" id='update_directorate' style='display:none;'
                                     class="inline-flex justify-center py-2 px-4 border-blue-600 border-2 shadow-sm 
                  text-sm font-medium rounded-md text-blue-400 bg-transparent hover:bg-blue-600 hover:text-blue-50
                  focus:outline-none focus:ring-1 focus:ring-offset-2 focus:ring-blue-500  w-full">
                                     Edit
                                         ...
                                         <tbody id='fetch_Alldir'>
                                             @if ($directorates && $directorates->count() > 0)
                                                 @foreach ($directorates as $directorate)
                                                     + <tr class="offerRow{{ $directorate->id }}"
                                                         class="bg-gray-100 hover:scale-95 transform transition-all ease-in">
                                                         <td class="p-3">
                                                             {{ $directorate->id }}
                                                         </td>
                                                         ...
                                                         <td class="p-3 flex justify-evenly ">
                                                             <a href="#" directorate="{{ $directorate->id }}"
                                                                 class="directorate_delete btn btn-danger"
                                                             ...
                                                             <a href="#" directorate="{{ $directorate->id }}"
                                                                 id="directorate_edit"
                                                                 class="text-gray-400 hover:text-yellow-100  ">
                                                                 <svg xmlns="http://www.w3.org/2000/svg"
                                                                     class="h-6 w-6" fill="none"
                                                                     viewBox="0 0 24 24" stroke="currentColor">
                                                                     <path stroke-linecap="round"
