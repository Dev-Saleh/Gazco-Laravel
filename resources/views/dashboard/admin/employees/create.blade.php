 ...
 <div class="px-4 py-4 sm:px-0">
        <h3 class="text-lg font-medium leading-6 text-gray-900">اضافة و عرض الوكلاء</h3>
      </div>
...
<!-- END Line -->
    ...
    <div class="mx-auto w-full">
        {{-- START SEARCH FORM --}}
        <form action="" method="Post" id='emplSearchForm'>
           @csrf 
        <div class="flex mx-auto w-full my-2">
                      
               
          <select  id="filterSearch" name="filterSearch"class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-r-lg focus:ring-blue-500 focus:border-blue-500 block w-40 p-2.5">
              <option value='all' selected>بحث الكل</option>
              <option value="empUserName">اسم الموظف</option>
              <option value="empRole">الصلاحية</option>
          </select>
     
          <div class="relative w-full">
              <button type="submit" id='search' class="h-12 absolute top-0 left-0 px-2 text-sm font-medium text-white bg-blue-700 rounded-l-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
