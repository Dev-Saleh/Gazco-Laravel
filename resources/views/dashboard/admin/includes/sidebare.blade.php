 <aside id="sidebar"
      class="sm:bg-red-500 md:bg-red-500  w-80 h-screen z-20 right-0 top-0 fixed lg:bg-slate-900 xl:bg-slate-800 font-cairo text-white text-4xl font-bold transition-all duration-300">
