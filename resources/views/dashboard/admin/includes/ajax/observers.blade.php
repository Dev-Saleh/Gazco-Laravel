        ...
        function fetchLastObserver($lastObserver)
          {
              ...
              $('#fetchLastObserver').prepend('<tr class="offerRow'+$lastObserver.id+' bg-white hover:scale-95 transform transition-all ease-in">\
            ...
            $.ajax({
                ...
                success: function(data) 
                {
                    ...
                    if (data.status == true)
                    {
                        ...
                        {
                          $('#fetchLastObserver').prepend('<tr class="offerRow'+resultSearch.id+' bg-white hover:scale-95 transform transition-all ease-in">\
                          ...
                          <div id="action-div" class="flex space-x-2  transition-all ease-in duration-150">\
                            <a onclick="deleteAlert();" href="#" obsId="'+resultSearch.id+'"  class="observerDelete btn btn-danger" class="text-gray-400  hover:text-red-400 float-left ">\
                              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">\
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />\
                              </svg>\
                            </a>\
                            <a href="#" obsId="'+resultSearch.id+'"   class="observerEdit text-gray-400 hover:text-yellow-400  mx-2">\
                              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">\
                                <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" />\
                              </svg>\
                            </a>\
