                ...
                <div class="flex flex-col">
                    <div class="">
                        <div class="relative z-0 w-full mb-5">
                            <input type="text" name="directorate_name" id="directorateName" placeholder=" " required
                                ...
                                <tbody id='fetchAllDirectorates'>
                                    @if ($directorates && $directorates->count() > 0)
                                        @foreach ($directorates as $directorate)
                                            <tr
                                                class="offerRow{{ $directorate->id }} bg-gray-50 hover:scale-95 transform transition-all ease-in">
                                                <td class="p-3">
                                                    {{ $directorate->id }}
                                                </td>
