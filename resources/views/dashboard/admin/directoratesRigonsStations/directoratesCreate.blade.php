<div class="col-span-2  transform hover:scale-110 hover:transition-all duration-300 ease-out">
     <form action="" method="POST" id='directorateForm'>
                 @csrf
                 <input type="text" name='id' style="display:none;" class="form-control" id="directorateId">
                 <div class="shadow overflow-hidden sm:rounded-md">
                     <div class="px-4 py-5 bg-white sm:p-6 flex flex-col items-center">
                         <div class="flex flex-col">
                             <div class="">
                                 <div class="relative z-0 w-full mb-5">
                                     <input type="text" name="directorate_name" id="directorateName" placeholder=" "
                                         required
                                         ...
                                         <tbody id='fetchAllDirectorates'>
                                             @if ($directorates && $directorates->count() > 0)
                                                 @foreach ($directorates as $directorate)
                                                     <tr class="offerRow{{ $directorate->id }} bg-gray-100 hover:scale-95 transform transition-all ease-in">
                                                         <td class="p-3">
                                                             {{ $directorate->id }}
                                                         </td>
                                                         ...
                                                         <td class="p-3 flex justify-evenly ">
                                                             <a href="#" directorateId="{{ $directorate->id }}"
                                                                 class="directorateDelete text-gray-400  hover:text-red-400  ">
                                                             ...
                                                             <a href="#" directorateId="{{ $directorate->id }}"
                                                                 class="directorateEdit text-gray-400 hover:text-yellow-100  ">
                                                                 <svg xmlns="http://www.w3.org/2000/svg"
                                                                     class="h-6 w-6" fill="none"
                                                                     viewBox="0 0 24 24" stroke="currentColor">
                                                                     <path stroke-linecap="round"
