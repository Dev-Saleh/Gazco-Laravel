<div class="col-start-5 col-end-8  transform hover:scale-110 hover:transition-all duration-300 ease-out">
    <form action="" method="POST" id='staForm'>
        @csrf
        <input type="text" name='id' style="display:none;" class="form-control" id="staId">
                ...
                <div class="flex flex-col">
                    <div class="">
                        <div class="relative z-0 w-full mb-5">
                            <input type="text" name="staName"  id="staName" placeholder=" " required
                            ...
                            <small id='staName_error' style='color:red'></small>
                        </div>
                        <button type="submit" id='saveStation'
                                ...
                                <tbody id='fetch_All_Stations'>
                                    @if ($Stations && $Stations->count() > 0)
                                        @foreach ($Stations as $Sta)
                                            <tr
                                                class="offerRow{{ $Sta->id }} bg-gray-50 hover:scale-95 transform transition-all ease-in">
                                                <td class="p-3">
                                                    {{ $Sta->id }}
                                                </td>
                                                ...
                                                <td class="p-3 flex justify-evenly ">
                                                    ...
                                                    <a href="#" staId="{{ $Sta->id }}"
                                                        ...
                                                        class="stationDelete text-red-400  hover:text-red-600  ">
                                                    ...
                                                    <a href="#" staId="{{ $Sta->id }}" 
                                                        class="stationEdit text-yellow-400 hover:text-yellow-600  ">
