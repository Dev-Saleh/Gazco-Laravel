<form class="container max-w-2xl mx-auto shadow-md md:w-3/4">
  <div class="p-4 bg-gray-50 border-t-2 border-indigo-400 rounded-lg bg-opacity-5">
      <div class="max-w-sm mx-auto md:w-full md:mx-0">
          <div class="inline-flex items-center">
              <a href="#" class="block relative">
                  <img alt="profil" src="/assest/Dev-SL.jpeg" class="mx-auto object-cover rounded-full h-16 w-16 "/>
              </a>
