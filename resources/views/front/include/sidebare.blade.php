  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
      ...
      <div>
        ...
        <div class="p-2.5 mt-2 flex items-center rounded-md px-4 duration-300 cursor-pointer  hover:bg-blue-600">
          ...
          <span class="text-[15px] mr-4 text-gray-200"> <a href='{{route('citizencheckBooking.index')}}'> معلوماتي الشخصيه </a></span>
        </div>
        ...
        <div class="p-2.5 mt-2 flex items-center rounded-md px-4 duration-300 cursor-pointer  hover:bg-blue-600">
          ...
          <span class="text-[15px] mr-4 text-gray-200"><a href='{{route('citizencheckBooking.index')}}'> استعلام عن حجوزاتي</a></span>
        </div>
