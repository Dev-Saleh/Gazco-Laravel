  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
      ...
      <div>
        ...
        <div class="p-2.5 mt-2 flex items-center rounded-md px-4 duration-300 cursor-pointer  hover:bg-blue-600">
          ...
          <span class="text-[15px] mr-4 text-gray-200"> <a href='{{route('myProfile.index')}}'> معلوماتي الشخصيه </a></span>
        </div>
        ...
        <div class="p-2.5 mt-2 flex items-center rounded-md px-4 duration-300 cursor-pointer  hover:bg-blue-600">
          ...
          <span class="text-[15px] mr-4 text-gray-200"><a href='{{route('myBooking.index')}}'> استعلام عن حجوزاتي</a></span>
        </div>
        ...
        <div class="p-2.5 mt-2 flex items-center rounded-md px-4 duration-300 cursor-pointer  hover:bg-blue-600">
          ...
          <span class="text-[15px] mr-4 text-gray-200"  ><a href='{{route('citizencheckBooking.index')}}'> استعلام عن الدفعات</a></span>
        </div>

        <div class="w-full relative inline-block py-3 text-white bg-transparent  rounded-tl-3xl
   ...
   <nav dir="ltr">
    <menu class="menu">
      ...
      <button class="menu__item flex flex-col  {{'/' == request()->path() ? 'active' : '' }}" style="--bgColorItem: #ff8c00;">
        <a href="{{route('Main.front')}}" >
        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="white" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
            <path stroke-linecap="round" stroke-linejoin="round"
              d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
        </svg>
      ...
      <button class="menu__item flex flex-col {{'myBooking' == request()->path() ? 'active' : '' }}" style="--bgColorItem: #f54888;">
      ...
      <button class="menu__item flex flex-col{{'' == request()->path() ? 'active' : '' }}" style="--bgColorItem: #4343f5;">
      <a href="https://wa.me/773928227?text=%D8%A7%D9%84%D8%B3%D9%84%D8%A7%D9%85%20%D8%B9%D9%84%D9%8A%D9%83%D9%85%20%D8%A7%D8%B1%D9%8A%D8%AF%20%D8%AA%D9%82%D8%AF%D9%8A%D9%85%20%D8%B4%D9%83%D9%88%D9%89">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" stroke="white" viewBox="0 0 24 24"  stroke-width="1.5">
      ...
      <button class="menu__item flex flex-col {{'checkBooking/index' == request()->path() ? 'active' : '' }}" style="--bgColorItem: #e0b115;">
        <a href="{{route('citizencheckBooking.index')}}">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="white"
          stroke-width="1">
          <path stroke-linecap="round" stroke-linejoin="round"
            d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
      ...
      <button class="menu__item flex flex-col {{'profile' == request()->path() ? 'active' : '' }}" style="--bgColorItem:#65ddb7;">
