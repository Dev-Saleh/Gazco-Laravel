  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
   ...
   <nav dir="ltr">
    <menu class="menu">
      ...
      <button class="menu__item flex flex-col {{'whatsapp/index' == request()->path() ? 'active' : '' }}" style="--bgColorItem: #00B2B6;">
      <a href="{{route('whatsapp.index')}}">
        <img class="h-8 w-8" src="{{ asset('assets/images/loginLogo/chat.png') }}"}}">
      </a>
      <p class="text-xs text-white font-thin">
        شكوى
      </p>
