  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
   ...
   <nav dir="ltr">
    <menu class="menu">
      ...
      <button class="menu__item {{'/' == request()->path() ? 'active' : '' }}" style="--bgColorItem: #ff8c00;">
      ...
      <button class="menu__item {{'myBooking' == request()->path() ? 'active' : '' }}" style="--bgColorItem: #f54888;">
      ...
      <button class="menu__item {{'' == request()->path() ? 'active' : '' }}" style="--bgColorItem: #4343f5;">
      <a href="">
      ...
      <button class="menu__item {{'checkBooking/index' == request()->path() ? 'active' : '' }}" style="--bgColorItem: #e0b115;">
      ...
      <button class="menu__item {{'profile' == request()->path() ? 'active' : '' }}" style="--bgColorItem:#65ddb7;">
